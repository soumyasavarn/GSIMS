...
--
CREATE TABLE curr_session ( id INT PRIMARY KEY );
...
(1, 'prakhar', 'prakhar', 1234567890, '2024-02-28 09:39:37'),
(2, 'sneh', 'sneh', 9876543211, '2024-02-28 03:24:12');
-- --------------------------------------------------------
...
('sankalp', 'sankalp', 8765432190, '2024-02-28 11:11:00', 1),
('ishan', 'ishan', 9090807060, '2024-03-01 02:05:54', 2);
...
(1, 'Households', 'Air Freshener', 110, 30),
(2, 'Kitchen', 'Sugar', 55, 12),
(3, 'Kitchen', 'Spice', 15, 37),
(4, 'Kitchen', 'Garam Masala', 35, 82),
(5, 'Fruits', 'Kiwi', 40, 10);
